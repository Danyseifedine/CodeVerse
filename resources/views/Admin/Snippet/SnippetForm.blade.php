...
@section('content')
    ...
    <div class="flex items-center justify-center p-12">
        ...
        <div class="mx-auto w-full max-w-[550px] bg-white">
            <form class="py-6 px-9" action="{{ route('SnippetStore') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <select name="snippet_type"
                        ...
                        <option value="">Select a type for you snippet</option>
                ...
                <div class="mb-6 pt-4">
                    ...
                    <div class="mb-8">
                        <textarea name="snippet_code" id="" cols="30" rows="10"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            value="" placeholder="Enter your snippet code here..."></textarea>
                        @error('snippet_code')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-8">
                        <select name="snippet_category"
                            id=""class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                            <option value="" selected>Select a category for you snippet</option>
